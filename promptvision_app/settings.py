"""
Django settings for promptvision_app project.
...
SECRET_KEY = "django-insecure-mw!!4$biz0*4(xn-%$3ope==_0(7o3!m4$8a6fg74m8+)5u_av"
...
WSGI_APPLICATION = "promptvision_app.wsgi.application"
